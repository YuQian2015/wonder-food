...
class PublicController {
  ...
  async initSystem(ctx) {
    const newRole = await ctx.service.role.createRole(ctx, { name: '超级管理员', key: 'root', system: true });
    await ctx.service.role.createRole(ctx, { name: '管理员', key: 'admin', system: true });
    await ctx.service.role.createRole(ctx, { name: '用户', key: 'user', system: true });
